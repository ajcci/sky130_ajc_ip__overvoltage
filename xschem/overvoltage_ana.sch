...
DESCRIPTION:
Overvoltage detector (analog section)} -830 560 0 0 0.8 0.8 {}
N 590 -60 700 -60 {
lab=dcomp}
N 930 -60 930 -30 {
lab=dcomp_filt}
...
C {devices/lab_pin.sym} -220 20 0 0 {name=p6 lab=ena_avdd}
...
C {devices/ipin.sym} -740 -210 0 0 {name=p26 lab=ena}
C {devices/ipin.sym} -740 -150 0 0 {name=p3 lab=isrc_sel}
...
C {cap_mim_m3_1.sym} 800 0 0 0 {name=C1 model=cap_mim_m3_1 W=20 L=20 MF=3 spiceprefix=X}
C {cap_mim_m3_2.sym} 930 0 0 0 {name=C2 model=cap_mim_m3_2 W=20 L=20 MF=3 spiceprefix=X}
...
C {sky130_fd_sc_hvl__lsbuflv2hv_1.sym} -650 -270 0 0 {name=xIlvls0[15:0] LVPWR=dvdd VGND=avss VNB=avss VPB=avdd VPWR=avdd prefix=sky130_fd_sc_hvl__ }
C {devices/ipin.sym} -740 -270 2 1 {name=p36 lab=otrip_decoded[15:0]}
C {devices/lab_pin.sym} -560 -270 2 0 {name=p37 sig_type=std_logic lab=otrip_decoded_avdd[15:0]}
C {sky130_fd_sc_hvl__lsbuflv2hv_1.sym} -650 -210 0 0 {name=xIlvls1 LVPWR=dvdd VGND=avss VNB=avss VPB=avdd VPWR=avdd prefix=sky130_fd_sc_hvl__ }
C {devices/lab_pin.sym} -560 -210 0 1 {name=p38 lab=ena_avdd}
C {sky130_fd_sc_hvl__lsbuflv2hv_1.sym} -650 -150 0 0 {name=xIlvls2 LVPWR=dvdd VGND=avss VNB=avss VPB=avdd VPWR=avdd prefix=sky130_fd_sc_hvl__ }
C {devices/lab_pin.sym} -560 -150 0 1 {name=p39 lab=isrc_sel_avdd}
C {devices/lab_pin.sym} -220 -40 0 0 {name=p27 lab=otrip_decoded_avdd[15:0]}
...
C {inv_4.sym} 1260 -60 0 0 {name=xIinv3 VGND=dvss VNB=dvss VPB=dvdd VPWR=dvdd prefix=sky130_fd_sc_hd__ }
C {inv_16.sym} 1380 -60 0 0 {name=xIinv4 VGND=dvss VNB=dvss VPB=dvdd VPWR=dvdd prefix=sky130_fd_sc_hd__ }
C {devices/title-3.sym} -1000 1080 0 0 {name=l1 author="Ajacci, Ltd. Co." rev=1.0 lock=false title="Overvoltage detector (Analog)"}
C {devices/opin.sym} 590 -250 0 0 {name=p43 lab=vin}
