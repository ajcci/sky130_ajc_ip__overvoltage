...
spiceprefix=X
mult=1}
C {devices/lab_pin.sym} 1170 50 2 1 {name=p29 lab=dvss}
...
C {sky130_fd_sc_hvl__lsbuflv2hv_1.sym} 430 -520 0 0 {name=xIlvls0[15:0] LVPWR=dvdd VGND=dvss VNB=dvss VPB=avdd VPWR=avdd prefix=sky130_fd_sc_hvl__ }
...
C {sky130_fd_sc_hvl__lsbuflv2hv_1.sym} 430 -460 0 0 {name=xIlvls1 LVPWR=dvdd VGND=dvss VNB=dvss VPB=avdd VPWR=avdd prefix=sky130_fd_sc_hvl__ }
C {devices/lab_pin.sym} 520 -460 0 1 {name=p38 lab=ena_avdd}
C {sky130_fd_sc_hvl__lsbuflv2hv_1.sym} 430 -400 0 0 {name=xIlvls2 LVPWR=dvdd VGND=dvss VNB=dvss VPB=avdd VPWR=avdd prefix=sky130_fd_sc_hvl__ }
...
C {xschem/pnp_05v5.sym} 10 -40 0 0 {name=Q1
