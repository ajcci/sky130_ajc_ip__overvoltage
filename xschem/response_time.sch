...
N 370 240 400 240 {
lab=GND}
C {devices/vsource.sym} 810 140 0 0 {name=Vavss value="DC 0" savecurrent=false}
...
C {devices/vsource.sym} 400 290 0 0 {name=Vena value="DC dvdd" savecurrent=false}
...
*.include /usr/local/share/pdk/sky130A/libs.tech/ngspice/sky130_fd_pr__model__pnp.model.spice
...
"}
C {devices/vsource.sym} 810 60 0 0 {name=Vavdd value="pwl (0 2 3m 6 6m 2) DC avdd" savecurrent=true}
C {devices/vsource.sym} 400 210 0 0 {name=Vbg value="DC 1.2" savecurrent=false}
...
C {devices/vsource.sym} 810 300 0 0 {name=Vdvss value="DC 0" savecurrent=false}
...
C {devices/vsource.sym} 810 220 0 0 {name=Vdvdd value="DC dvdd" savecurrent=true}
...
C {devices/vsource.sym} 590 300 0 0 {name=Vvotrip0 value="DC dvdd" savecurrent=true}
C {devices/lab_pin.sym} 590 270 2 0 {name=p14 sig_type=std_logic lab=otrip[0]}
C {devices/vsource.sym} 590 220 0 0 {name=Vvotrip1 value="DC dvdd" savecurrent=true}
C {devices/lab_pin.sym} 590 190 2 0 {name=p19 sig_type=std_logic lab=otrip[1]}
C {devices/vsource.sym} 590 140 0 0 {name=Vvotrip2 value="DC dvdd" savecurrent=true}
C {devices/lab_pin.sym} 590 110 2 0 {name=p21 sig_type=std_logic lab=otrip[2]}
C {devices/vsource.sym} 590 60 0 0 {name=Vvotrip3 value="DC dvdd" savecurrent=true}
C {devices/lab_pin.sym} 590 30 2 0 {name=p8 sig_type=std_logic lab=otrip[3]}
C {devices/vsource.sym} 400 130 0 0 {name=Visrc_sel value="DC 0" savecurrent=false}
C {devices/lab_pin.sym} 400 100 2 0 {name=p10 sig_type=std_logic lab=isrc_sel}
C {devices/code_shown.sym} -910 230 0 0 {name=CONTROL only_toplevel=false value="
...
echo $&vtript_f $&vtrip_f >> trip.data
echo $&hyst >> trip.data
plot avdd xiovr.xiana.dcomp i(Vavdd)*1000
.endc
"}
