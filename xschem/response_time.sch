...
"}
C {devices/vsource.sym} 810 60 0 0 {name=Vavdd value="pwl (0 3.3 10u 3.3 10.01u 3.9 100u 3.9 100.01u 3.3) DC avdd" savecurrent=true}
...
C {devices/vsource.sym} 590 140 0 0 {name=Vvotrip2 value="DC 0" savecurrent=true}
C {devices/lab_pin.sym} 590 110 2 0 {name=p21 sig_type=std_logic lab=otrip[2]}
C {devices/vsource.sym} 590 60 0 0 {name=Vvotrip3 value="DC 0" savecurrent=true}
