...
DESCRIPTION: Overvoltage detector testbench} -910 450 0 0 0.4 0.4 {}
N 130 70 140 70 {
lab=avdd_bg}
N 140 20 140 70 {
lab=avdd_bg}
...
.option warn=1
"}
C {devices/vsource.sym} 810 60 0 0 {name=Vavdd value="DC \{Vavdd\}" savecurrent=true}
...
C {devices/code_shown.sym} -910 170 0 0 {name=CONTROL only_toplevel=false value=".control
op
set wr_singlescale
